...
|[Statistics](http://yahoo.github.io/mdbm/api/group__StatisticsGroup.html)|mdbm_count_records, mdbm_count_pages, mdbm_enable_stat_operations , mdbm_set_stat_time_func, mdbm_get_stat_time, *~~mdbm_get_stat_counter~~, ~~mdbm_get_stat_time~~, ~~mdbm_reset_stat_operations~~, ~~mdbm_set_stats_func~~, ~~mdbm_get_stats~~, ~~mdbm_get_db_info~~, ~~mdbm_chunk_iterate~~, ~~mdbm_get_db_stats~~, ~~mdbm_get_window_stats~~*|
