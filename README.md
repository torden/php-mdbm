...
|Group|API|
|---|---|
|[File Management](http://yahoo.github.io/mdbm/api/group__FileManagementGroup.html)|mdbm_open, mdbm_close, mdbm_sync, mdbm_fsync, *~~mdbm_close_fd~~, ~~mdbm_dup_handle~~, ~~mdbm_replace_db~~, ~~mdbm_replace_file~~, ~~mdbm_pre_split~~, ~~mdbm_fcopy~~*|
